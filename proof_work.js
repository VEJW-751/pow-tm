...
/**
 * @param {string} challenge_js
 * @param {string} prefix_js
 * @returns {Promise<any>}
 */
export function find_proof(challenge_js, prefix_js) {
    const ret = wasm.find_proof(challenge_js, prefix_js);
    return ret;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('proof_work_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
